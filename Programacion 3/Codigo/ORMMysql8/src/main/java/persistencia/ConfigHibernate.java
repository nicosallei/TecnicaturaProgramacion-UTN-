   ...
   private static SessionFactory sessionFactory;
    ...
    public static void load(){
        ...
        try {
            ...
            config.setProperty("hibernate.connection.url", "jdbc:mysql://localhost:3306/ormfactura?useTimezone=true&serverTimezone=UTC");
            ...
            config.addAnnotatedClass(FacturaDetalle.class);
            config.addAnnotatedClass(Proveedor.class);
            config.addAnnotatedClass(TipoArticulo.class);
