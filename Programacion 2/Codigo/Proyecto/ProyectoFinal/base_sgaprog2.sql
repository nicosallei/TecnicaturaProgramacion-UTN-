...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-06-2023 a las 01:34:25
...
(84293483, 'Amadeo', 'Romera', '2012-06-21', 'San Juan', '+2647564657', NULL),
(85351098, 'Geronimo', 'Del Castillo', '2012-06-21', 'San Juan', '+2647564657', NULL),
(85647564, 'Iñigo', 'Barbera', '2020-06-11', 'Mendoza', '+2617564657', NULL),
(94536574, 'Nicolasa', 'Padilla', '2012-06-21', 'Mendoza', '+2617564657', NULL);
...
--
ALTER TABLE `cursado`
  ADD CONSTRAINT `cursado_ibfk_1` FOREIGN KEY (`cur_alu_dni`) REFERENCES `alumno` (`alu_dni`) ON DELETE NO ACTION ON UPDATE NO ACTION;
