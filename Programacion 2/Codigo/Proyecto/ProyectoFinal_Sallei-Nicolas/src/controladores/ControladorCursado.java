   ...
   private Cursado cursado = new Cursado();
    ...
    public void agregar() {
        ...
        if (revisarCampos() == false) {
            ...
            cursado.getCodigoMateria().setCodMateria(splitearString(agregarCursado.getCbxMaterias().getSelectedItem().toString()));
    ...
    public void editar() {
        if (val.validarNota(Double.parseDouble(editarCursado.getTxtNota().getText())) == false) {
           ...
           cursado.setCodigoMateria(new Materia());
           cursado.getCodigoMateria().setCodMateria(splitearString(editarCursado.getTxtMateria().getText()));
    ...
    public void listarCursados(JTable table) {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            fila[1] = lista.get(i).getCodigoMateria().getCodMateria();
