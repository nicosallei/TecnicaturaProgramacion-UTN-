...
public class ControladorMaterias implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == panelMaterias.getBtnNuevo()) {
            // hace que no aparezca de nuevo las cosas
            agregarMateria.getTxtCodMateria().setText("");
            agregarMateria.getTxtNombre().setText("");
    ...
    public void eliminar() {
        ...
        if (fila == -1) {
            ...
            if (JOptionPane.showConfirmDialog(null, "Desea Elimnar? Se van a eliminar todas las notas de esta materia", "Seleccione Una Opc.", JOptionPane.YES_NO_OPTION) == 0) {
