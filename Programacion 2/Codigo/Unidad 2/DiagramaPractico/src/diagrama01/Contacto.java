...
public class Contacto extends Persona {
    ...
    public Contacto(Integer idPersona,String nombre, String apellido,Integer idContacto,ContactoTipo tipo) {
       ...
       public Contacto(Integer idPersona,String nombre, String apellido,Integer idContacto,Integer idContactoTipo,String descripcion) {
        super(nombre, apellido, idPersona);
        this.idContacto = idContacto;
         this.tipo =new ContactoTipo(idContactoTipo,descripcion);
