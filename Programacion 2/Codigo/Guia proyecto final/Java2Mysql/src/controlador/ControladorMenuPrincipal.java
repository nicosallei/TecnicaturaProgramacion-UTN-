...
public class ControladorMenuPrincipal implements ActionListener, MouseListener  {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource().equals(this.menuPrincipal.getjMenuCliente())){
            ...
            this.agregarIntCliente.getjTable_Clientes().setModel(this.controladorCliente.tablaClientes(this.controladorCliente.getArrayListCliente()));
            ...
            this.controladorCliente.agregarCliente( this.agregarIntCliente.getjT_Dni().getText(), this.agregarIntCliente.getjT_Nombre().getText(), this.agregarIntCliente.getjT_Apellido().getText(), this.agregarIntCliente.getjT_Telefono().getText(), this.agregarIntCliente.getjSexo().getSelection().getActionCommand());
            this.agregarIntCliente.getjTable_Clientes().setModel(this.controladorCliente.tablaClientes(this.controladorCliente.getArrayListCliente()));
