    ...
    public partial class Form1 : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (codigo != "" && nombre != ""  && precio_publico > 0 && existencias > 0)
                {


                    string sql = "INSERT INTO productos (codigo, nombre," +
                        "descripcion, precio_publico, existencia) VALUES ('" + codigo + "'," +
                        " '" + nombre + "', '" + descripcion + "', '" +
                        precio_publico + "', '" + existencias + "')";
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            string sql = "UPDATE  productos SET codigo='"+codigo+ "', nombre='"+nombre+ "'," +
                "descripcion='"+descripcion+ "', precio_publico='"+precio_publico+ "', existencia='"+existencias+ "' WHERE id='"+id+"'";
